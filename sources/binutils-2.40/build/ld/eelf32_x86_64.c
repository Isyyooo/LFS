...
OUTPUT_ARCH(i386:x64-32)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"=/mnt/lfs/tools/x86_64-lfs-linux-gnu/libx32\"); SEARCH_DIR(\"=/usr/local/libx32\"); SEARCH_DIR(\"=/libx32\"); SEARCH_DIR(\"=/usr/libx32\"); SEARCH_DIR(\"=/mnt/lfs/tools/x86_64-lfs-linux-gnu/lib\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
